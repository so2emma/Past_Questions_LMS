...
<head>
    ...
    <title>Language Academy | Home</title>
</head>

<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="#">Language Academy</a>
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item mx-2">
                        <a class="btn btn-sm btn-outline-light" href="signin.html">Sign In</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-md-8 py-5">
                    <h1 class="display-3 fw-bold">Language Academy</h1>
                    <p class="lead ">The Future Of Learning....</p>
                </div>
                <div class="col-md-4 notification ">
                    <p class="lead fw-bold">Earn up to $500 Monthly.</p>
                    <p class="lead fw-bold">
                        Learn and Earn. <br>
                        Become Our Language Ambassador.
                    </p>
            ...
            <div class="row align-items-center">
                <div class="col-md-7 text-justify">
                    <div class="heading text-start">
                        <h3 class="">WHAT DO WE SELL?</h3>

                    </div>
                    <p>
                        We promote the learning of INTERNATIONAL LANGUAGES AND INDIGENOUS LANGUAGES. <br>
                        <strong>INTERNATIONAL LANGUAGES: FRENCH GERMAN SPANISH AND CHINESE</strong><br>
                        -For business, education or leisure purposes. <br>
                        <strong>INDIGENOUS LANGUAGES: YORUBA,IGBO AND HAUSA</strong><br>
                        Learning indigenous language helps the learner to connect to his or her root. <br>
                    </p>
                </div>
                <div class="col-md-5">
    ...
    <section id="class" class="py-5 ">
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-md-5">
                    <img src="img/home-2.png" class="img-fluid" alt="">
                </div>
                <div class="col-md-7 text-justify">
                    <div class="heading">
                        <h3 class=""> OUR VIRTUAL CLASS</h3>

                    </div>
                    <p class="">
                        Learning indigenous language helps the learner to connect to his or her root OUR VIRTUAL CLASS
                        STUDENTS LEARN FROM THE COMFORT OF THEIR HOMES
                    </p>
                    <hr>
                    <div class="heading text-center">
                        <h3 class=""> OUR PACKAGES</h3>
    ...
    <section id="ambassador" class="py-5 bg-primary">
        <div class="container py-5">
            <div class="heading text-center">
                <h3 class=""> BE AN AMBASSADOR</h3>
            ...
            <div class="row py-5 align-items-center">
                <div class="col-md-7">
                    <div class="heading text-center">
                        <h3 class=""> AS A LANGUAGE AMBASSADOR</h3>

                    </div>
                    <p>
                        You are expected to promote our LANGUAGE ACADEMY through your social media space and get paid
                        handsomely. <br> We create a special coded link for you to generate your own referrals. <br> We
                        also give you opportunity to register other LANGUAGE AMBASSADORS and get paid for life.
                    </p>
                </div>
                <div class="col-md-5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="img-fluid" data-name="Layer 1" width="1098.75"
                        height="632.37039" viewBox="0 0 1098.75 632.37039" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>heatmap</title>
                        ...
                        <circle cx="197.05271" cy="12.74148" r="6.79546" fill="#228190" />
                        <circle cx="219.13794" cy="12.74148" r="6.79546" fill="#228190" />
                        <circle cx="241.22317" cy="12.74148" r="6.79546" fill="#228190" />
                        <polygon
                        ...
                        <circle cx="350" cy="291.01368" r="54" fill="#228190" opacity="0.3" />
                        <circle cx="350" cy="291.01368" r="36" fill="#228190" opacity="0.3" />
                        <circle cx="350" cy="291.01368" r="25" fill="#228190" />
                        <circle cx="804.375" cy="157.1852" r="54" fill="#228190" opacity="0.3" />
                        <circle cx="804.375" cy="157.1852" r="36" fill="#228190" opacity="0.3" />
                        <circle cx="804.375" cy="157.1852" r="25" fill="#228190" />
                        <circle cx="814" cy="532.01368" r="54" fill="#228190" opacity="0.3" />
                        <circle cx="814" cy="532.01368" r="36" fill="#228190" opacity="0.3" />
                        <circle cx="814" cy="532.01368" r="25" fill="#228190" />
                        <rect x="141.09287" y="215.02041" width="22.24232" height="28.59727"
                            transform="translate(244.80285 330.54921) rotate(-177.77929)" fill="#228190" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-50.625 -133.8148)" fill="#228190" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-50.625 -133.8148)" fill="#575a89" />
                        <path d="M145.764,403.451s33.65163,5.58313,25.971,15.7098-37.49194-.51979-37.49194-.51979Z"
                            transform="translate(-50.625 -133.8148)" fill="#ffb9b9" />
                        <path
        ...
        <footer class=" text-light bg-primary py-5">
            <div class="container text-center">
                <p>copyright &copy; <span id="year"></span> LanguageAcademy</p>
            </div>
        </footer>
